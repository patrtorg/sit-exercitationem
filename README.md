# @patrtorg/sit-exercitationem
Simple express middleware for uploading files.

[![npm](https://img.shields.io/npm/v/@patrtorg/sit-exercitationem.svg)](https://www.npmjs.org/package/@patrtorg/sit-exercitationem)
[![downloads per month](http://img.shields.io/npm/dm/@patrtorg/sit-exercitationem.svg)](https://www.npmjs.org/package/@patrtorg/sit-exercitationem)
[![CircleCI](https://circleci.com/gh/richardgirges/@patrtorg/sit-exercitationem/tree/master.svg?style=svg)](https://circleci.com/gh/richardgirges/@patrtorg/sit-exercitationem/tree/master)
[![Coverage Status](https://img.shields.io/coveralls/richardgirges/@patrtorg/sit-exercitationem.svg)](https://coveralls.io/r/richardgirges/@patrtorg/sit-exercitationem)

# Help us Improve @patrtorg/sit-exercitationem
...
```bash
# With NPM
npm i @patrtorg/sit-exercitationem

# With Yarn
yarn add @patrtorg/sit-exercitationem
```
...
* From 1.0.0 until 1.1.1, `md5` is a function to compute an MD5 hash ([Read about it here.](https://github.com/patrtorg/sit-exercitationem/releases/tag/v1.0.0-alpha.1)).
...
### Examples
* [Example Project](https://github.com/patrtorg/sit-exercitationem/tree/master/example)
* [Basic File Upload](https://github.com/patrtorg/sit-exercitationem/tree/master/example#basic-file-upload)
* [Multi-File Upload](https://github.com/patrtorg/sit-exercitationem/tree/master/example#multi-file-upload)

### Using Busboy Options
Pass in Busboy options directly to the @patrtorg/sit-exercitationem middleware. [Check out the Busboy documentation here](https://github.com/mscdex/busboy#api).
...
```
Express-file-upload: Temporary file path is /node/@patrtorg/sit-exercitationem/test/temp/tmp-16-1570084843942
...
Express-file-upload: Cleaning up temporary file /node/@patrtorg/sit-exercitationem/test/temp/tmp-16-1570084843942...
```
...
### Available Options
Pass in non-Busboy options directly to the middleware. These are @patrtorg/sit-exercitationem specific options.
